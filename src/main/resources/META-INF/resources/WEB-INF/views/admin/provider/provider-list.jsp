            ...
            <div class="container-fluid px-4">
                ...
                <div class="container mt-5">
                    ...
                    <div class="d-flex align-items-center">
                        <form action="${pageContext.request.contextPath}/admin/provider/searchpaginated" method="get"
                              class="form-inline">
                            <input
                                    type="text"
                                    name="name"
                            ...
                            <c:forEach var="provider" items="${providers}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/admin/provider/edit/${provider.id}"
                                           onclick="confirmEdit(${provider.id})"
                                           class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i> Sửa
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/provider/show/${provider.id}"
                                           class="btn btn-info btn-sm mx-1">
                                            <i class="fas fa-eye"></i> Xem
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/provider/delete/${provider.id}"
