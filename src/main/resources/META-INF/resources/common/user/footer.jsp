                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-3 col-lg-2">
                        <div class="site-footer__widget footer-links">
                            ...
                            <ul class="footer-links__list">
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">About
                                    Us</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Delivery
                                    Information</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Privacy
                                    Policy</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Brands</a>
                                </li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Contact
                                    Us</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#"
                                                                  class="footer-links__link">Returns</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Site
                                    Map</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2">
                        <div class="site-footer__widget footer-links">
                            ...
                            <ul class="footer-links__list">
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Store
                                    Location</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Order
                                    History</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Wish
                                    List</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#"
                                                                  class="footer-links__link">Newsletter</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#"
                                                                  class="footer-links__link">Specials</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#" class="footer-links__link">Gift
                                    Certificates</a></li>
                                <li class="footer-links__item"><a href="${URL}assets/#"
                        ...
                        <div class="site-footer__widget footer-newsletter">
                            ...
                            <ul class="footer-newsletter__social-links">
                                <li
                                    ...
                                    <a href="${URL}assets/https://themeforest.net/user/kos9" target="_blank"><i
